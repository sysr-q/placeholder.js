/**
 * This jQuery plugin allows developers to quickly and easily
 * implement placeholder images on the fly, without having to
 * rely on an external source, or wasting their own bandwidth.
 *
 * BMP images are generated on the fly, and put in place via
 * base64 image/bmp data in the image source attribute.
 *
 * @see https://github.com/plausibility/placeholder.js
 * @author Christopher "plausibility" Carter <chris@gibsonsec.org>
 * @license MIT 
 */
(function ($) {
